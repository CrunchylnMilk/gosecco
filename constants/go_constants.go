...
func init() {
	...
	RegisterSyscall("userfaultfd", 323)
	RegisterSyscall("membarrier", 324)
	RegisterSyscall("mlock2", 325)
	RegisterSyscall("copy_file_range", 326)
	RegisterSyscall("preadv2", 327)
	RegisterSyscall("pwritev2", 328)
	RegisterSyscall("pkey_mprotect", 329)
	RegisterSyscall("pkey_alloc", 330)
	RegisterSyscall("pkey_free", 331)
	RegisterSyscall("statx", 332)
	RegisterSyscall("io_pgetevents", 333)
	RegisterSyscall("rseq", 334)
	RegisterSyscall("pidfd_send_signal", 424)
	RegisterSyscall("io_uring_setup", 425)
	RegisterSyscall("io_uring_register", 427)
	RegisterSyscall("open_tree", 428)
	RegisterSyscall("move_mount", 429)
	RegisterSyscall("fsopen", 430)
	RegisterSyscall("fsconfig", 431)
	RegisterSyscall("fsmount", 432)
	RegisterSyscall("fspick", 433)
	RegisterSyscall("pidfd_open", 434)
	RegisterSyscall("clone3", 435)
	RegisterSyscall("close_range", 436)
	RegisterSyscall("openat2", 437)
	RegisterSyscall("pidfd_getfd", 438)
	RegisterSyscall("faccessat2", 439)
	RegisterSyscall("process_madvise", 440)
	RegisterSyscall("epoll_pwait2", 441)
	RegisterSyscall("mount_setattr", 442)
	RegisterSyscall("quotactl_fd", 443)
	RegisterSyscall("landlock_create_ruleset", 444)
	RegisterSyscall("landlock_add_rule", 445)
	RegisterSyscall("landlock_restrict_self", 446)
	RegisterSyscall("memfd_secret", 447)
	RegisterSyscall("process_mrelease", 448)
	RegisterSyscall("futex_waitv", 449)
	RegisterSyscall("set_mempolicy_home_node", 450)
	RegisterSyscall("cachestat", 451)
	RegisterSyscall("fchmodat2", 452)
	RegisterSyscall("map_shadow_stack", 453)
	RegisterSyscall("futex_wake", 454)
	RegisterSyscall("futex_wait", 455)
	RegisterSyscall("futex_requeue", 456)
}
